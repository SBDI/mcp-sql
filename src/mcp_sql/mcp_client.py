...
server_params = StdioServerParameters(
    ...
    args=["src/mcp_sql/mcp_server.py"],  # Updated path
        ...
        try:
            ...
            async with stdio_client(server_params) as (read_stream, write_stream):
                async with ClientSession(read_stream, write_stream) as session:
                    ...
                    logger.info(f"Available tools: {response.tools}")
                    available_tools = [
                        {
                            "type": "function",
                            "function": {
                    ...
                    logger.info("Making initial Groq API call")
                    ...
                    logger.info(f"Initial response received: {res}")
